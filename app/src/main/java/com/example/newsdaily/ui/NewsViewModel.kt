...
import com.example.newsdaily.NewsApplication
...
class NewsViewModel(
    ...
    private suspend fun safeSearchNewsCall(searchQuery: String) {
        ...
        try {
            ...
            when(t){
                is IOException -> searchNews.postValue(Resource.Error("Error Failure"))
    ...
    private suspend fun safeBreakingNewsCall(countryCode: String) {
        ...
        try {
            ...
            when(t){
                is IOException -> breakingNews.postValue(Resource.Error("Error Failure"))
